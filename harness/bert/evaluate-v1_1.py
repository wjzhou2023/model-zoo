...
def evaluate_files(dataset_file, prediction_file, max_examples):
    ...
    return evaluate(dataset, predictions, max_examples)
...
if __name__ == '__main__':
    ...
    print(json.dumps(evaluate_files(args.dataset_file, args.prediction_file, args.max_examples)))
