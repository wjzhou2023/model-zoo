...
import importlib  
evaluate = importlib.import_module("evaluate-v1_1")

def main(args, results):
    print("Reading examples...")
    eval_examples = read_squad_examples(input_file=args.data,
    ...
    write_predictions(eval_examples, eval_features, results, 20, 30, True, args.out_file, args.count)

    print("Evaluating predictions...")
    return evaluate.evaluate_files(
        args.data,
        args.out_file,
        args.count)
...
def evaluator(args, results):
    return main(args, results)
